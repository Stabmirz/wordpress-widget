...
class Greeting_Widget extends WP_Widget {
  ...
  **/
  ...
  public function widget( $args, $instance ) {
    ...
    $greetings=array("Hello and Welcome to my Page."=>"one", "Oh, hi there! I make websites that 'function' and 'sparkle'."=>"two","Hi there! I craft beautiful & usable websites."=>"three","Hello, my name is Abida Mirza, I'm a web developer & I love to create beautiful User Interfaces"=>"four","Hi, I'm Abida. I'm a passionate webdesigner who love to create cleane websites.Check it out!"=>"one");?>
